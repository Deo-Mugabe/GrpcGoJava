...
type Memory struct {
	...
	Unit          Memory_Unit            `protobuf:"varint,2,opt,name=unit,proto3,enum=Pc_Store.Memory_Unit" json:"unit,omitempty"`
...
const file_memory_message_proto_rawDesc = "" +
	"\n" +
	"\x14memory_message.proto\x12\bPc_Store\"\xa9\x01\n" +
	"\x06Memory\x12\x14\n" +
	"\x05value\x18\x01 \x01(\x04R\x05value\x12)\n" +
	"\x04unit\x18\x02 \x01(\x0e2\x15.Pc_Store.Memory.UnitR\x04unit\"^\n" +
	"\x04Unit\x12\v\n" +
	...
	"\bTERABYTE\x10\x06B\x06Z\x04.;pbb\x06proto3"
...
var file_memory_message_proto_goTypes = []any{
	(Memory_Unit)(0), // 0: Pc_Store.Memory.Unit
	(*Memory)(nil),   // 1: Pc_Store.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: Pc_Store.Memory.unit:type_name -> Pc_Store.Memory.Unit
