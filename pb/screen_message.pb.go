...
type Screen struct {
	...
	Panel         Screen_Panel           `protobuf:"varint,3,opt,name=panel,proto3,enum=Pc_Store.Screen_Panel" json:"panel,omitempty"`
...
const file_screen_message_proto_rawDesc = "" +
	"\n" +
	"\x14screen_message.proto\x12\bPc_Store\"\x95\x02\n" +
	"\x06Screen\x12\x1b\n" +
	"\tsize_inch\x18\x01 \x01(\x02R\bsizeInch\x12;\n" +
	"\n" +
	"resolution\x18\x02 \x01(\v2\x1b.Pc_Store.Screen.ResolutionR\n" +
	"resolution\x12,\n" +
	"\x05panel\x18\x03 \x01(\x0e2\x16.Pc_Store.Screen.PanelR\x05panel\x12\x1e\n" +
	"\n" +
...
var file_screen_message_proto_goTypes = []any{
	(Screen_Panel)(0),         // 0: Pc_Store.Screen.Panel
	(*Screen)(nil),            // 1: Pc_Store.Screen
	(*Screen_Resolution)(nil), // 2: Pc_Store.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: Pc_Store.Screen.resolution:type_name -> Pc_Store.Screen.Resolution
	0, // 1: Pc_Store.Screen.panel:type_name -> Pc_Store.Screen.Panel
