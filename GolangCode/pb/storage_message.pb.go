...
type Storage struct {
	...
	Driver        Storage_Driver         `protobuf:"varint,1,opt,name=driver,proto3,enum=Pc_Store.Storage_Driver" json:"driver,omitempty"`
...
const file_storage_message_proto_rawDesc = "" +
	"\n" +
	"\x15storage_message.proto\x12\bPc_Store\x1a\x14memory_message.proto\"\x8e\x01\n" +
	"\aStorage\x120\n" +
	"\x06driver\x18\x01 \x01(\x0e2\x18.Pc_Store.Storage.DriverR\x06driver\x12(\n" +
	"\x06memory\x18\x02 \x01(\v2\x10.Pc_Store.MemoryR\x06memory\"'\n" +
	"\x06Driver\x12\v\n" +
...
var file_storage_message_proto_goTypes = []any{
	(Storage_Driver)(0), // 0: Pc_Store.Storage.Driver
	(*Storage)(nil),     // 1: Pc_Store.Storage
	(*Memory)(nil),      // 2: Pc_Store.Memory
}
var file_storage_message_proto_depIdxs = []int32{
	0, // 0: Pc_Store.Storage.driver:type_name -> Pc_Store.Storage.Driver
	2, // 1: Pc_Store.Storage.memory:type_name -> Pc_Store.Memory
