...
type Keyboard struct {
	...
	Layout        Keyboard_Layout        `protobuf:"varint,1,opt,name=layout,proto3,enum=Pc_Store.Keyboard_Layout" json:"layout,omitempty"`
...
const file_keyboard_message_proto_rawDesc = "" +
	"\n" +
	"\x16keyboard_message.proto\x12\bPc_Store\"\x92\x01\n" +
	"\bKeyboard\x121\n" +
	"\x06layout\x18\x01 \x01(\x0e2\x19.Pc_Store.Keyboard.LayoutR\x06layout\x12\x18\n" +
...
var file_keyboard_message_proto_goTypes = []any{
	(Keyboard_Layout)(0), // 0: Pc_Store.Keyboard.Layout
	(*Keyboard)(nil),     // 1: Pc_Store.Keyboard
}
var file_keyboard_message_proto_depIdxs = []int32{
	0, // 0: Pc_Store.Keyboard.layout:type_name -> Pc_Store.Keyboard.Layout
