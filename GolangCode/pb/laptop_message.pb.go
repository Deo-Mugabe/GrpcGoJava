...
const file_laptop_message_proto_rawDesc = "" +
	"\n" +
	"\x14laptop_message.proto\x12\bPc_Store\x1a\x17processor_message.proto\x1a\x14memory_message.proto\x1a\x15storage_message.proto\x1a\x14screen_message.proto\x1a\x16keyboard_message.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xf6\x03\n" +
	"\x06Laptop\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	"\x05brand\x18\x02 \x01(\tR\x05brand\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12\x1f\n" +
	"\x03cpu\x18\x04 \x01(\v2\r.Pc_Store.CPUR\x03cpu\x12\"\n" +
	"\x03ram\x18\x05 \x01(\v2\x10.Pc_Store.MemoryR\x03ram\x12!\n" +
	"\x04gpus\x18\x06 \x03(\v2\r.Pc_Store.GPUR\x04gpus\x12-\n" +
	"\bstorages\x18\a \x03(\v2\x11.Pc_Store.StorageR\bstorages\x12(\n" +
	"\x06screen\x18\b \x01(\v2\x10.Pc_Store.ScreenR\x06screen\x12.\n" +
	"\bkeyboard\x18\t \x01(\v2\x12.Pc_Store.KeyboardR\bkeyboard\x12\x1d\n" +
	"\tweight_kg\x18\n" +
...
var file_laptop_message_proto_goTypes = []any{
	(*Laptop)(nil),                // 0: Pc_Store.Laptop
	(*CPU)(nil),                   // 1: Pc_Store.CPU
	(*Memory)(nil),                // 2: Pc_Store.Memory
	(*GPU)(nil),                   // 3: Pc_Store.GPU
	(*Storage)(nil),               // 4: Pc_Store.Storage
	(*Screen)(nil),                // 5: Pc_Store.Screen
	(*Keyboard)(nil),              // 6: Pc_Store.Keyboard
	(*timestamppb.Timestamp)(nil), // 7: google.protobuf.Timestamp
}
var file_laptop_message_proto_depIdxs = []int32{
	1, // 0: Pc_Store.Laptop.cpu:type_name -> Pc_Store.CPU
	2, // 1: Pc_Store.Laptop.ram:type_name -> Pc_Store.Memory
	3, // 2: Pc_Store.Laptop.gpus:type_name -> Pc_Store.GPU
	4, // 3: Pc_Store.Laptop.storages:type_name -> Pc_Store.Storage
	5, // 4: Pc_Store.Laptop.screen:type_name -> Pc_Store.Screen
	6, // 5: Pc_Store.Laptop.keyboard:type_name -> Pc_Store.Keyboard
	7, // 6: Pc_Store.Laptop.updated_at:type_name -> google.protobuf.Timestamp
